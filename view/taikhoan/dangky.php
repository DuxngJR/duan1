<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="index.php?act=dangky" method="POST">
            <div>
            ...
            <div>
                <input type="submit" name="dangky" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 my-1" value="Đăng ký"></input>
                <div class="text-center m-2">
                    <a href="index.php?act=dangnhap" class="font-semibold text-indigo-600 hover:text-indigo-500 underline ">Tôi Đã Có Tài Khoản</a>
                </div>
            </div>
        </form>
